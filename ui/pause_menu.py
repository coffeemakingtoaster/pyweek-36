...
class pause_menu(ui_base):
    def __init__(self):
        ...
        continue_button = DirectButton(text=("Continue"),pos=(0,0,0), scale=0.2, command=self.unpause_game, text_font=self.font, relief=None, text_fg=(255,255,255, 1))
        self.ui_elements.append(continue_button)
        
        main_menu_button = DirectButton(text=("Return to main menu"), pos=(0,0,-0.6), scale=0.2, command=self.goto_main_menu, text_font=self.font, relief=None, text_fg=(255,255,255,1))
