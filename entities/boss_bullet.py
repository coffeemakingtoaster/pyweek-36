...
class boss_bullet_entity(enity_base):
    ...
    def update(self, dt):
        ...
        self.travelled_distance += Vec3(self.direction * 30 * dt).length()
        ...
        self.model.setX(self.model.getX() + self.direction.x * 30 * dt)
        self.model.setZ(self.model.getZ() + self.direction.z * 30 * dt)
